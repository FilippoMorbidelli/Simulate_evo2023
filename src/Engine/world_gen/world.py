...
class World:
            ...
            match event:
                case "Load":
                    ...
                    if status == "Init":
                        ...
                        r_id, r_coord, mesh = data
                        # Add Chunks and Meshes
                        self.asynch_load_region(r_id, r_coord, mesh)
                        # Update local load process status
                        self.load_status = status
    ...
    def asynch_load_region(self, r_id, r_coord, mesh):
        ...
        for c_id in mesh.keys():
            ...
            chunk.build_mesh(asynch=True, vao=mesh[c_id])
